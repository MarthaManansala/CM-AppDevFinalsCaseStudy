...
public class June extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button d1 = findViewById(R.id.june1btn);
        d1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(June.this, SetOfButtons.class);
        ...
        Button d2 = findViewById(R.id.june2btn);
        ...
        Button d3 = findViewById(R.id.june3btn);
        ...
        Button d4 = findViewById(R.id.june4btn);
        ...
        Button d5 = findViewById(R.id.june5btn);
        ...
        Button d6 = findViewById(R.id.june6btn);
        ...
        Button d7 = findViewById(R.id.june7btn);
        ...
        Button d8 = findViewById(R.id.june8btn);
        ...
        Button d9 = findViewById(R.id.june9btn);
        ...
        Button d10 = findViewById(R.id.june10btn);
        ...
        Button d11 = findViewById(R.id.june11btn);
        ...
        Button d12 = findViewById(R.id.june12btn);
        ...
        Button d13 = findViewById(R.id.june13btn);
        ...
        Button d14 = findViewById(R.id.june14btn);
        ...
        Button d15 = findViewById(R.id.june15btn);
        ...
        Button d16 = findViewById(R.id.june16btn);
        ...
        Button d17 = findViewById(R.id.june17btn);
        ...
        Button d18 = findViewById(R.id.june18btn);
        ...
        Button d19 = findViewById(R.id.june19btn);
        ...
        Button d20 = findViewById(R.id.june20btn);
        ...
        Button d21 = findViewById(R.id.june21btn);
        ...
        Button d22 = findViewById(R.id.june22btn);
        ...
        Button d23 = findViewById(R.id.june23btn);
        ...
        Button d24 = findViewById(R.id.june24btn);
        ...
        Button d25 = findViewById(R.id.june25btn);
        ...
        Button d26 = findViewById(R.id.june26btn);
        ...
        Button d27 = findViewById(R.id.june27btn);
        ...
        Button d28 = findViewById(R.id.june28btn);
        ...
        Button d29 = findViewById(R.id.june29btn);
        ...
        Button d30 = findViewById(R.id.june30btn);
        ...
        Button btnReturnToMay = findViewById(R.id.btnReturnToMay);
        btnReturnToMay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(June.this, May.class);
                startActivity(intent);
            }
        });
