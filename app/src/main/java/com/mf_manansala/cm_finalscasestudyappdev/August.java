...
public class August extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button d1 = findViewById(R.id.august1btn);
        d1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(August.this, SetOfButtons.class);
                intent.putExtra("PickedMonth", "August");
                intent.putExtra("PickedDay", 1);
                startActivity(intent);
            }
        });

        Button d2 = findViewById(R.id.august2btn);
        ...
        Button d3 = findViewById(R.id.august3btn);
        ...
        Button d4 = findViewById(R.id.august4btn);
        ...
        Button d5 = findViewById(R.id.august5btn);
        ...
        Button d6 = findViewById(R.id.august6btn);
        ...
        Button d7 = findViewById(R.id.august7btn);
        ...
        Button d8 = findViewById(R.id.august8btn);
        ...
        Button d9 = findViewById(R.id.august9btn);
        ...
        Button d10 = findViewById(R.id.august10btn);
        ...
        Button d11 = findViewById(R.id.august11btn);
        ...
        Button d12 = findViewById(R.id.august12btn);
        ...
        Button d13 = findViewById(R.id.august13btn);
        ...
        Button d14 = findViewById(R.id.august14btn);
        ...
        Button d15 = findViewById(R.id.august15btn);
        ...
        Button d16 = findViewById(R.id.august16btn);
        ...
        Button d17 = findViewById(R.id.august17btn);
        ...
        Button d18 = findViewById(R.id.august18btn);
        ...
        Button d19 = findViewById(R.id.august19btn);
        ...
        Button d20 = findViewById(R.id.august20btn);
        ...
        Button d21 = findViewById(R.id.august21btn);
        ...
        Button d22 = findViewById(R.id.august22btn);
        ...
        Button d23 = findViewById(R.id.august23btn);
        ...
        Button d24 = findViewById(R.id.august24btn);
        ...
        Button d25 = findViewById(R.id.august25btn);
        ...
        Button d26 = findViewById(R.id.august26btn);
        ...
        Button d27 = findViewById(R.id.august27btn);
        ...
        Button d28 = findViewById(R.id.august28btn);
        ...
        Button d29 = findViewById(R.id.august29btn);
        ...
        Button d30 = findViewById(R.id.august30btn);
        ...
        Button d31 = findViewById(R.id.august31btn);
        ...
        Button btnReturnToJuly = findViewById(R.id.btnReturnToJuly);
        btnReturnToJuly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(August.this, July.class);
                startActivity(intent);
            }
        });
